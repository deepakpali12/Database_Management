...
Query- update employees set salary =46000.00 where name='alice johnson';

A query to delete the employee record for Bob Brown.
  
Query- delete from employees where name='bob brown';

A query to find the employees who have a salary greater than 48000.
  
Query- select* from employees where salary>48000.00;

A query to add a new column email to the employees table.
  
Query- add email varchar(35);

A query to update the email for John Doe to john.doe@company.com
  
Query- update employees set email='john.doe@company.com' where name='john doe';
...
Query- select count(*) from employees where date_of_joining>'2020-01-01';
